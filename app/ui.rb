...
class ClickableReactiveLabel # when reused need to change many things
    include Themed
...
class SwitchWithLabel # when reused need to change many things
    include Themed
...
class SimpleArithmaticLabel # when reused need to change many things
    include Themed
    attr_accessor :text, :pos, :switch_width, :switch_height, :text_size, :text_width, :text_height, :var_change_amount, :changing_var, :is_offset
